//////////////////////////////////////////////////////////
// This file has been modiefiled for v8a version 
...
public :
   ...
   std::vector<float> leadjet_NsubJettiness_vars;
   ...
   //Jet Substructure
   std::vector<float> Jet_nSubjettiness(std::vector<fastjet::PseudoJet> clusters);
