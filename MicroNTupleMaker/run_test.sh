...
#./exe/MicroNTupleMaker user.ebusch.515500.MGPy8EG_SVJSChan2j_2000_4.v8a.mc20e_tree.root true /eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v8/
#./exe/MicroNTupleMaker user.ebusch.700349.Sh_2211_Wtaunu_H_maxHTpTV2_CVetoBVeto.v9c.mc20e_tree.root true /eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v9/
./exe/MicroNTupleMaker user.ebusch.data15_13TeV.periodAllYear.v12b_tree.root true /eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v12/
...
#./exe/MicroNTupleMaker user.ebusch.364710.Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ10WithSW.v8a.mc20e_tree.root true /eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v8/
./exe/MicroNTupleMaker user.ebusch.364703.Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ3WithSW.v12b.mc20d_tree.root true /eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v12/
