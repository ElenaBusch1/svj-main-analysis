...
eosPath = "root://eosatlas.cern.ch//eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v12/v12.2/"
...
if __name__ == "__main__":
    ...
    for file_list in ["v12p2_sig1_condor_files.txt"]:
        ...
        for filePath in files:
            ...
            os.system("echo 'initialdir = /afs/cern.ch/work/e/ebusch/public/SVJ/ana-exot-2021-19/condor/v12.2' >> submit.sub")
